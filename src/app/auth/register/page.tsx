      ...
      <div className="min-h-screen bg-[#FDF8F3] flex flex-col">
        ...
        <main className="flex-1 flex items-start sm:items-center justify-center px-5 pb-20">
          <div className="w-full max-w-[420px] text-center">
            ...
            <h1 className="text-2xl font-black text-[#111111] mb-3">Verifique seu email</h1>
            <p className="text-sm text-neutral-500 mb-2">
              Enviamos um link de confirmacao para:
            </p>
            <p className="text-sm font-semibold text-[#111111] mb-6">{email}</p>
            <p className="text-xs text-neutral-400 mb-8">
              Clique no link no email para ativar sua conta e comecar a gerar suas fotos profissionais.
            </p>
            <Link
              href="/auth/login"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#FF7A1A] hover:bg-[#e86c10] text-white font-bold text-sm transition-all shadow-lg shadow-orange-200"
            >
      ...
      <main className="flex-1 flex items-start sm:items-center justify-center px-5 pb-20">
        <div className="w-full max-w-[420px]">
          <div className="text-center mb-8">
            <h1 className="text-2xl sm:text-3xl font-black text-[#111111] tracking-tight">Crie sua conta</h1>
            <p className="text-sm text-neutral-500 mt-2">
              Comece a gerar fotos profissionais com IA
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-neutral-400 font-medium">ou cadastre com email</span>
            <div className="flex-1 h-px bg-neutral-200" />
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div>
              <label className="text-xs font-semibold text-neutral-500 uppercase tracking-wider mb-1.5 block">Nome</label>
          ...
          <p className="text-center text-[11px] text-neutral-400 mt-4">
            ...
            <Link href="#" className="underline hover:text-neutral-600">Termos de Uso</Link> e{' '}
            <Link href="#" className="underline hover:text-neutral-600">Politica de Privacidade</Link>.
          </p>

          {/* Login link */}
          <p className="text-center text-sm text-neutral-500 mt-6">
            Ja tem uma conta?{' '}
            <Link href={`/auth/login${next !== '/wizard' ? `?next=${next}` : ''}`} className="text-[#FF7A1A] font-semibold hover:underline">
              Fazer login
            </Link>
          </p>
