...
export default function StepHairLength() {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold mb-1.5 tracking-tight">Comprimento do cabelo</h2>
        ...
        {options.map(opt => {
          ...
          return (
            <button
              ...
              className={cn(
                'relative flex flex-col items-center gap-3 pt-6 pb-4 px-3 rounded-xl border transition-all duration-150',
                selected
